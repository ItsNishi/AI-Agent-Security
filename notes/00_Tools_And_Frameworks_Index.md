...
| Tool | Description | Source | Notes |
|------|-------------|--------|-------|
| Garak | NVIDIA; 37+ probe modules; 23 backends; prompt injection/jailbreak/data leakage testing | Open-source (NVIDIA) | [14](14_AI_Hacking_Frameworks.md) |
| Promptfoo | 300K+ devs; 50+ vuln types; YAML CI/CD; OWASP/NIST/MITRE compliance mapping | https://www.promptfoo.dev | [14](14_AI_Hacking_Frameworks.md) |
