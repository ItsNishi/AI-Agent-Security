...
- **35,000+ email addresses** (17K owner emails + 29K from developer signups)
...
- [Palo Alto Unit 42 -- MCP Prompt Injection Attack Vectors](https://unit42.paloaltonetworks.com/model-context-protocol-attack-vectors/)
...
- [Palo Alto Networks -- Guide to MCP Vulnerabilities](https://www.paloaltonetworks.com/resources/guides/simplified-guide-to-model-context-protocol-vulnerabilities)
...
- [Vulnerable MCP Project](https://vineethsai.github.io/vulnerablemcp/)

### AI Coding Tool Vulnerabilities
- [Embrace The Red -- Copilot RCE via Prompt Injection (CVE-2025-53773)](https://embracethered.com/blog/posts/2025/github-copilot-remote-code-execution-via-prompt-injection/)
...
- [Tigran.tech -- Securing AI Coding Agents](https://tigran.tech/securing-ai-coding-agents-idesaster-vulnerabilities/)
- [Persistent Security -- Copilot Wormable Command Execution](https://www.persistent-security.net/post/part-iii-vscode-copilot-wormable-command-execution-via-prompt-injection)
- [NSFOCUS -- Cursor RCE (CVE-2025-54135)](https://nsfocusglobal.com/cursor-remote-code-execution-vulnerability-cve-2025-54135/)
- [arXiv -- "Your AI, My Shell" Prompt Injection in Coding Editors](https://arxiv.org/html/2509.22040v1)
...
- [Lakera -- Agentic AI Threats: Memory Poisoning & Goal Hijacks](https://www.lakera.ai/blog/agentic-ai-threats-p1)
- [arXiv -- Memory Poisoning Attack and Defense on Memory-Based LLM Agents](https://arxiv.org/html/2601.05504v2)

### Moltbook / Vibe Coding
- [Wiz -- Exposed Moltbook Database Reveals 1.5M API Keys](https://www.wiz.io/blog/exposed-moltbook-database-reveals-millions-of-api-keys)
- [Infosecurity Magazine -- Vibe-Coded Moltbook Exposes User Data](https://www.infosecurity-magazine.com/news/moltbook-exposes-user-data-api/)
- [CyberIndemnity -- When Vibe Coding Fails: Moltbook Breach](https://cyberindemnity.org/2026/02/when-vibe-coding-fails-security-lessons-from-the-moltbook-breach/)
- [Fortune -- AI Leaders Warn Against Moltbook](https://fortune.com/2026/02/02/moltbook-security-agents-singularity-disaster-gary-marcus-andrej-karpathy/)
- [Veracode -- Vibe Coding and GenAI Security](https://www.veracode.com/blog/genai-security-and-vibe-coding/)
- [Veracode -- Base44 Vulnerability](https://www.veracode.com/blog/base44-vulnerability-sparks-conversations-on-securing-vibe-coding/)
- [Palo Alto Unit 42 -- Securing Vibe Coding Tools](https://unit42.paloaltonetworks.com/securing-vibe-coding-tools/)
- [Apiiro -- Vibe Coding Security Best Practices](https://apiiro.com/blog/vibe-coding-security-best-practices/)
...
- [The Hacker News -- MCP Prompt Injection for Attack and Defense](https://thehackernews.com/2025/04/experts-uncover-critical-mcp-and-a2a.html)
