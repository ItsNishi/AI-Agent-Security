...
> **Related notes**: [01 -- Skill Injection Analysis](01_Skill_Injection_Analysis.md) (injection techniques used in ClawHavoc), [07 -- Skill Scanning & Detection](07_Skill_Scanning_And_Detection_Landscape.md) (scanning tools for malicious skills), [13 -- AI Application Ecosystem Security](13_AI_Application_Ecosystem_Security.md) (broader marketplace security landscape)
...
5. **Cross-references in Note 12**: See [Agent Configuration Files](./10_Agent_MD_Configuration_Files.md) for CLAUDE.md-specific attacks
